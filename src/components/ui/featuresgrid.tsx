...
export const Component = ({ className }: { className?: string }) => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 right-1/4 w-[700px] h-[500px] bg-emerald-500/[0.02] blur-[170px] pointer-events-none -z-10" />

      <div className="mx-auto max-w-6xl px-6 md:px-8">
        {/* Section Header */}
        <div className="mb-16 flex flex-col items-center text-center">
          <div className="mb-6 inline-flex items-center rounded-full border border-emerald-500/20 bg-emerald-500/10 px-4 py-1.5 text-xs font-mono font-medium uppercase tracking-widest text-emerald-300">
          ...
          <h2 className="mb-4 max-w-3xl text-balance text-4xl font-semibold tracking-tight text-white sm:text-5xl md:text-6xl font-urbanist">
            ...
            <span className="text-zinc-400">Remain Yours</span>
          </h2>
        ...
        {/* Bento Grid Layout - Exact 5 Items with 3D Frosted Glass Icons */}
        <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2">
          {/* Feature 1: Zero Data Retention (Large Card) */}
          <div className="group flex min-h-[320px] flex-col justify-between overflow-hidden rounded-2xl border border-white/[0.12] bg-[#050505] transition-all duration-300 hover:border-emerald-500/30 hover:bg-[#080808] md:col-span-2 shadow-2xl">
              ...
              <div className="w-full max-w-md overflow-hidden rounded-xl border border-white/[0.12] bg-black font-mono text-[11px] leading-relaxed text-zinc-400 sm:text-xs shadow-xl">
                ...
                <div className="p-4 space-y-1.5">
                  ...
                  <div className="flex justify-between text-zinc-400">
                    ...
                    <span className="text-emerald-400 font-bold">0% (PURGED)</span>
                  </div>
                  <div className="flex justify-between text-zinc-400">
            ...
            <div className="border-t border-white/[0.08] bg-white/[0.02] p-6">
              <div className="mb-2 flex items-center gap-3 text-white">
                <GlassIcon type="zero-retention" size="sm" />
          ...
          <div className="group flex min-h-[320px] flex-col justify-between overflow-hidden rounded-2xl border border-white/[0.12] bg-[#050505] transition-all duration-300 hover:border-violet-500/30 hover:bg-[#080808] shadow-2xl">
            <div className="flex flex-1 items-center justify-center p-6 sm:p-8">
              <div className="w-full max-w-[220px] break-all font-mono text-[11px] leading-relaxed text-zinc-400 bg-black p-4 rounded-xl border border-white/[0.12]">
                ...
                <div className="text-[10px] text-zinc-300 flex items-center justify-between">
                  <span className="text-violet-300">AES-256-GCM</span>
            ...
            <div className="border-t border-white/[0.08] bg-white/[0.02] p-6">
              <div className="mb-2 flex items-center gap-3 text-white">
                <GlassIcon type="encryption" size="sm" />
          ...
          <div className="group flex min-h-[320px] flex-col justify-between overflow-hidden rounded-2xl border border-white/[0.12] bg-[#050505] transition-all duration-300 hover:border-cyan-500/30 hover:bg-[#080808] shadow-2xl">
            <div className="flex flex-1 items-center justify-center p-6 sm:p-8">
              <div className="flex flex-col gap-2.5 w-full max-w-[220px]">
                {[
                  { label: "User Data Control", status: "Active", color: "text-emerald-400 bg-emerald-500/10 border-emerald-500/20" },
                  { label: "Indefinite Collection", status: "Disabled", color: "text-zinc-400 bg-white/10 border-white/10" },
                  { label: "Conversation Keys", status: "User-Owned", color: "text-cyan-300 bg-cyan-500/10 border-cyan-500/20" },
                ].map((item, i) => (
                  <div
                    key={i}
          ...
          <div className="group flex min-h-[320px] flex-col justify-between overflow-hidden rounded-2xl border border-white/[0.12] bg-[#050505] transition-all duration-300 hover:border-indigo-500/30 hover:bg-[#080808] md:col-span-2 shadow-2xl">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-6 sm:p-8 flex-1 items-center">
              <div className="p-4 rounded-xl bg-black border border-indigo-500/20 space-y-2 flex items-start gap-3">
                <GlassIcon type="tee" size="sm" className="shrink-0" />
                <div>
                  <div className="text-indigo-300 text-xs font-mono font-semibold">
                    Trusted Execution Environment (TEE)
                  </div>
                  <p className="text-xs text-zinc-300 font-geist leading-relaxed mt-1">
                    Hardware-isolated confidential compute protection.
                  </p>
                </div>
              </div>

              <div className="p-4 rounded-xl bg-black border border-emerald-500/20 space-y-2 flex items-start gap-3">
                <GlassIcon type="privacy" size="sm" className="shrink-0" />
                <div>
                  <div className="text-emerald-300 text-xs font-mono font-semibold">
                    Frictionless Start
                  </div>
                  <p className="text-xs text-zinc-300 font-geist leading-relaxed mt-1">
                    Direct access without forced account creation workflows.
                  </p>
                </div>
              </div>
            </div>
